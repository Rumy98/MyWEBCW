...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/css/bootstrap.min.css"> <script
>
</head> <body>
src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script> src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
<div class="container">
<h2></h2>
...
$("#apply").click(function(){ if($('#promo_code').val()!=''){
<script>
$.ajax({
type: "POST",
url: "process.php",
...
var dataResult = JSON.parse(dataResult); if(dataResult.statusCode==200){
}
